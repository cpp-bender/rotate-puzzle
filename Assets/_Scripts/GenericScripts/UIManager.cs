...
public class UIManager : MonoBehaviour
{
    ...
    {
        if (FailManager.Instance.isLevelFailed || FailManager.Instance.isLevelCompleted)
        {
            DOTween.Clear(false);
    ...
    public void StartLevel()
    {
        if (!isLevelStartedForUI)
        {
            ...
            ReferenceManager.Instance.brickState = BrickState.Rotate;
        }
    }
    ...
    public void SkipButton()
    {
        ...
        FailManager.Instance.isLevelFailed = false;
        FailManager.Instance.isLevelCompleted = true;
